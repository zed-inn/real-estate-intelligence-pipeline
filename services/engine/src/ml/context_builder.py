...
import os
import re
from src.gen.events_pb import PropertyIngestedEvent
from src.gen.property.property_pb import Property, ext_info, FieldSection

json_path = os.path.join(
    os.path.dirname(__file__), 
    "..", "gen", "property", "property_section_startings.json"
)
...
def build_intelligence_context(payload: PropertyIngestedEvent) -> str:
    ...
    for field in Property.desc().fields:
        value = getattr(payload.property, field.name, None)
