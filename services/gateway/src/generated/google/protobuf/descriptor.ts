...
export const FileDescriptorProto: MessageFns<FileDescriptorProto> = {
  encode(message: FileDescriptorProto, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.optionDependency !== undefined && message.optionDependency.length !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 15: {
          ...
          const el = reader.string();
          if (el !== undefined) {
            message.optionDependency!.push(el);
          }
          continue;
        }
        case 4: {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          const el = ExtensionRangeOptions_Declaration.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.declaration!.push(el);
          }
          continue;
        }
        case 50: {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 20: {
          ...
          const el = FieldOptions_EditionDefault.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.editionDefaults!.push(el);
          }
          continue;
        }
        case 21: {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          const el = FeatureSetDefaults_FeatureSetEditionDefault.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.defaults!.push(el);
          }
          continue;
        }
        case 4: {
